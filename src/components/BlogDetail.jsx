        ...
        <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex gap-2">
            <div className="flex-1">
              <div className="flex-shrink-0 mb-4 md:mb-0 lg:mb-5 xl:mb-0 mr-0 md:mr-6">
                <img
            ...
            <div className="flex-initial w-72">
              <h2 className="text-2xl font-semibold mb-2 text-custom-black text-center bg-gray-300 p-2 rounded-custom-br">Artikel Lainnya</h2>
                  ...
                  article.slice(0, 5).map((art, index) => (
                    <div key={index} className="p-3 rounded-custom-br w-full flex flex-col">
                      ...
                      <div className="mt-2">
                        ...
                        <h3 className="text-lg text-start font-bold text-gray-800">{art.name}</h3>
                      </div>
                    </div>
                  ))
                ) : (
