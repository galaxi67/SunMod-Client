        ...
        <div className="mt-20 space-y-32 text-custom-black mx-auto">
          ...
          >
            <div className="title-content space-y-4 order-2 md:order-1 mt-6 md:mt-0">
              <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-extrabold tracking-wide">
                METODE CIRCLE CLAMP
              </h1>
              <div className="text-sm sm:text-xl xl:text-2xl">
                <h2 className="font-light leading-2 text-justify mb-4">
                  Metode sunat Circle Clamp adalah teknik sunat modern yang menggunakan alat bernama "Circle Clamp"
                  untuk mempermudah dan mempercepat proses sunat.
                </h2>
          ...
          >
            ...
            <div className="title-content space-y-4 ml-auto mt-6 md:mt-0">
              ...
              <div className="text-sm sm:text-xl xl:text-2xl">
                <h2 className="font-light leading-2 text-justify mb-4">
                  Metode sunat tekno sealer adalah teknik sunat modern yang menggunakan alat khusus bernama "sealer"
                  untuk memotong dan mengikat pembuluh darah secara otomatis.
                </h2>
                <h3 className="font-semibold bg-emerald-100 text-custom-black p-3 tracking-wide inline-block rounded-custom-br">
          ...
          >
            <div className="title-content space-y-4 order-2 md:order-1 mt-6 md:mt-0">
              ...
              <div className="text-sm sm:text-xl xl:text-2xl">
                <h2 className="font-light leading-2 text-justify mb-4">
                  Metode sunat Super Ring adalah teknik sunat modern yang menggunakan alat khusus bernama "Super Ring"
                  untuk mempermudah prosedur khitan.
                </h2>
                <h3 className="font-semibold bg-emerald-100 text-custom-black p-3 tracking-wide inline-block rounded-custom-br">
          ...
          >
            ...
            <div className="title-content space-y-4 ml-auto mt-6 md:mt-0">
              <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-extrabold tracking-wide">
                METODE TRIMMING FORCEP
              </h1>
              <div className="text-sm sm:text-xl xl:text-2xl">
                <h2 className="font-light leading-2 text-justify mb-4">
                  Metode sunat Trimming Forcep merupakan kombinasi antara konvensional dengan metode modern yang
                  mengedepankan kenyamanan dan estetika hasil, dapat digunakan semua kondisi.
                </h2>
                <h3 className="font-semibold bg-emerald-100 text-custom-black p-3 tracking-wide inline-block rounded-custom-br">
