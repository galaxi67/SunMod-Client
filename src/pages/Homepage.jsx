      ...
      <div className="max-w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex justify-center items-center md:order-2">
            <span>BERBAGAI METODE YANG KAMI GUNAKAN</span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 mt-4">
          <div className="flex justify-start items-center">LAYANAN SUMOD</div>
        ...
        <div className="mt-5 px-4 sm:px-6 lg:px-8 max-w-screen-xl mx-auto">
          <div className="flex justify-center mb-5">ARTIKEL</div>
          <div className="relative flex gap-3 overflow-x-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-50">
            {articles.map((article) => (
              <div
                key={article.id}
                className="bg-white shadow-custom rounded-custom-br overflow-hidden flex-none w-[120px] sm:w-[350px] lg:w-[280px]"
              >
                <img
                  src={article.picture}
                  alt={article.name}
